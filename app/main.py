...
def create_app() -> FastAPI:
    ...
    # 静态文件服务（带缓存控制）
    app.mount("/static", CachedStaticFiles(directory=str(settings.static_path)), name="static")
    app.mount("/uploads", CachedStaticFiles(directory=str(settings.upload_path)), name="uploads")
